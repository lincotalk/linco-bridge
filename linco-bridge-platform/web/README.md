...
与 Flutter `chat_input_toolbar` / `constants` 对齐：

| Agent | 工作区选择 | Profile 切换 | 模型 + 推理设置 |
|-------|-----------|-------------|----------------|
| Codex | ✅ | — | ✅（紧凑工具栏 `项目 \| 设置 ⌄`） |
| Claude | ✅ | — | ✅ |
| Hermes | — | ✅ | — |
...
| 模块 | 职责 |
|------|------|
| `useBridgeConnection` | 连接检测、setup 刷新 |
...
| `useContextPicker` | Hermes Profile 选择 |
...
| `BridgeContextPickerSheet` | Hermes Profile 选择 |
