...
- Official services and production backends must treat connector frames as untrusted input, including frames from modified or forked clients. Validate identity, session ownership, event state, payload size, and file metadata server-side.
