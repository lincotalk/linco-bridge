...
const { handleSlashCommand, _internal: slashCommandInternals } = require('../../src/commands');
const agentSelection = require('../../src/commands/agentSelection');
...
{
  const slashPath = require.resolve('../../src/commands');
  ...
  const { handleSlashCommand: handleSlashCommandWithMock } = require('../../src/commands');
